...
// const { scripts } = require('https://cdn.datatables.net/1.11.5/js/dataTables.bootstrap5.min.js');
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");

__webpack_require__(/*! ./empleado_ajax */ "./resources/js/empleado_ajax.js"); // require('./popper.min');
...
$("#message").hide(); //DOM.load

$(document).ready(function () {
  var formulario = document.querySelector("#form");
  var formularioImage = document.querySelector("#form_image"); //listar
  ...
  var tabla = $('#t_empleados').DataTable({
    ...
    "columns": [{
      ...
      render: function render(data, type, row) {
        if (data.file == '') {
          return "<img class=\"h-10 w-10 rounded-full\" data-id=\"".concat(data.id, "\" data=\"").concat(data.file, "\"\n                                            src=\"\" alt=\"\" id=\"image\">");
        } else {
          return "<img class=\"h-10 w-10 rounded-full\" data-id=\"".concat(data.id, "\" data=\"").concat(data.file, "\"\n                                            src=\"").concat(data.file, "\" alt=\"\" id=\"image\">");
        }
      }
    }, {
      data: 'nombre'
      ...
      data: null,
      render: function render(data, type, row) {
        return "<button data-id=\"".concat(data.id, "\" data-nombre=\"").concat(data.nombre, "\"class=\"btn btn-primary modal_edit\" id=\"edit\">edit</button>");
      }
    }, {
      data: null,
      render: function render(data, type, row) {
        return "<button data-id=\"".concat(data.id, "\" data-nombre=\"").concat(data.nombre, "\"class=\"btn btn-danger eliminar\" id=\"eliminar\">eliminar</button>");
      }
    }]
  }); //guardar
